...
public class FileHelper {
    ...
    public static String getFileTypeByHeader(File inputFile) {
        ...
        try {
            ...
            XMLConfiguration xmlConfig = new XMLConfiguration(ClassLoader.getSystemResource("validation-rules.xml"));
...
//			System.out.println("");
            ...
            if (null == header) {
                LOGGER.warn("Null header, returning unknown file type:  " + inputFile.getAbsolutePath());
